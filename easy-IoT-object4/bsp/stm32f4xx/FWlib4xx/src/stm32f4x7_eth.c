...
/**
  ...
  * @param  ETH_InitStruct: pointer to a ETH_InitTypeDef1 structure which will be initialized.
  * @retval None
  */
void ETH_StructInit(ETH_InitTypeDef1* ETH_InitStruct)
{
...
/**
  ...
  * @param ETH_InitStruct: pointer to a ETH_InitTypeDef1 structure that contains
  *   the configuration information for the specified ETHERNET peripheral.
  * @param PHYAddress: external PHY address                    
  * @retval ETH_ERROR: Ethernet initialization failed
  *         ETH_SUCCESS: Ethernet successfully initialized                 
  */
uint32_t ETH_Init(ETH_InitTypeDef1* ETH_InitStruct, uint16_t PHYAddress)
{
