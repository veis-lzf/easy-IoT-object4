...
again:
    ...
    do
    {
        ...
        aliyun_iot_mqtt_yield(&client, 6000);
...
{
    sys_thread_new("aliyun_mqtt_demo", aliyun_mqtt_demo, 0, TASK_IOT_CLIENT_STK_SIZE, TASK_IOT_CLIENT_PRIO);
}
#endif
