...
#include "GUIDebug.h"
//#include "ili9320.h"//ÒÆÖ²LCDÇý¶¯ add by LC 2015.06.29 23:56
...
void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex) {
  ...
  {
    /* ... */
		Gui_DrawPoint(xPhys,yPhys,PixelIndex);//ÒÆÖ²LCDÇý¶¯ add by LC 2015.06.29 23:56
  }
}
...
unsigned int LCD_L0_GetPixelIndex(int x, int y) {
  ...
  {
    PixelIndex = Lcd_ReadPoint(xPhys,yPhys);/* ... *///ÒÆÖ²LCDÇý¶¯ add by LC 2015.06.29 23:56
  }
  return PixelIndex;
}
