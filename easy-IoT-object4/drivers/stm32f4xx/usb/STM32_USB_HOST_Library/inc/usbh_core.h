...
#define MSC_SCSI_SUB_CLASS	   0x06
...
typedef enum
{
	HOST_IDLE = 0, HOST_ISSUE_CORE_RESET, HOST_DEV_ATTACHED, HOST_DEV_DISCONNECTED, HOST_ISSUE_RESET, HOST_DETECT_DEVICE_SPEED, HOST_ENUMERATION, HOST_CLASS_REQUEST, HOST_CLASS, HOST_CTRL_XFER, HOST_USR_INPUT, HOST_SUSPENDED, HOST_ERROR_STATE
} HOST_State;
...
typedef enum
{
	CTRL_IDLE = 0, CTRL_SETUP, CTRL_SETUP_WAIT, CTRL_DATA_IN, CTRL_DATA_IN_WAIT, CTRL_DATA_OUT, CTRL_DATA_OUT_WAIT, CTRL_STATUS_IN, CTRL_STATUS_IN_WAIT, CTRL_STATUS_OUT, CTRL_STATUS_OUT_WAIT, CTRL_ERROR
} CTRL_State;
...
typedef struct _USBH_USR_PROP
{
	...
	void(*DeviceAddressAssigned)(void); /* Address is assigned to USB
	Device */
...
void wake_up_urb(USB_OTG_CORE_HANDLE *, int);
...
extern USB_OTG_CORE_HANDLE USB_OTG_Core; //need align
