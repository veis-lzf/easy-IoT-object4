...
#if WIFI_CHIP == 8782
	extern const unsigned char fm_88w[249580];
#elif WIFI_CHIP == 8801
	extern const unsigned char fm_88w[255536];
#endif
...
//	gpio_cfg((uint32_t)FLASH_WP_PORT  , FLASH_WP_PIN, GPIO_Mode_Out_PP);
	...
	GPIO_PinAFConfig(FLASH_CLK_PORT, FLASH_CLK_PIN_SOURCE,  GPIO_AF_SPI1);
	GPIO_PinAFConfig(FLASH_MISO_PORT, FLASH_MISO_PIN_SOURCE, GPIO_AF_SPI1);
	GPIO_PinAFConfig(FLASH_MOSI_PORT, FLASH_MOSI_PIN_SOURCE, GPIO_AF_SPI1);
